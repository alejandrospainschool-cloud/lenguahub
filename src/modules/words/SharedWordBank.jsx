    ...
    <div className="w-full mx-auto px-4 md:px-8 min-h-[60vh] flex flex-col pb-12">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        ...
        <div className="flex gap-2 w-full sm:w-auto shrink-0">
          ...
          {currentFolder && (
            <button
              onClick={() => handleDeleteFolder(currentFolder.name, currentFolder.id)}
              className="flex items-center gap-2 bg-red-600/20 hover:bg-red-600/30 text-red-400 hover:text-red-300 px-4 py-2.5 rounded-xl font-bold text-sm border border-red-500/30 hover:border-red-500/50 active:scale-[.97] transition-all shrink-0"
